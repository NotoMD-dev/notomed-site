    ...
    <section className="bg-white p-6 rounded-2xl shadow-xl border border-gray-100">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
        ...
        <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
          ...
          <div className="mt-3">
            <div className="rounded-xl border border-[color:var(--hero-tone-sage-border)] bg-[color:var(--hero-tone-sage-surface)] px-4 py-3 flex items-center justify-between gap-4">
              <p className="text-[color:var(--hero-tone-sage-title)] font-mono text-sm truncate">
