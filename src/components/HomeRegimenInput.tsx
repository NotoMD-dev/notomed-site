      ...
      {rows.length === 0 && opioidNaive ? (
        ...
        <div className="overflow-x-auto">
          <div className="min-w-[900px]">
            {/* LABELS */}
            <div
              className="grid gap-x-3 gap-y-1 text-xs font-semibold text-gray-600 uppercase mb-0.5 px-1"
              style={rowGridStyle}
            >
              <div>Drug</div>
              <div>Route</div>
            ...
            {rows.map((r: HomeMedRow) => {
              ...
              return (
                <div
                  key={r.id}
                  className="grid gap-3 items-start px-2 py-1 mb-1 border-b border-gray-100 last:border-b-0"
                  style={rowGridStyle}
                >
