      ...
      {rows.length === 0 && opioidNaive ? (
        ...
        <div className="overflow-x-auto">
          <div className="min-w-[900px]">
            {/* LABELS */}
            <div
              className="grid gap-2 text-xs font-semibold text-gray-600 uppercase mb-1 px-1 items-end"
              style={rowGridStyle}
            >
              <div>Drug</div>
              <div>Route</div>
            ...
            {rows.map((r: HomeMedRow) => {
              ...
              return (
                <div
                  key={r.id}
                  className="grid gap-2 items-start p-2 mb-2 border-b border-gray-100 last:border-b-0"
                  style={rowGridStyle}
                >
