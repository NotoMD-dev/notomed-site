...
export function HomeRegimenInput() {
  ...
  const detailSummaryClass =
    "px-3 py-1.5 rounded-lg border border-[color:var(--hero-tone-sage-border)] bg-[color:var(--hero-tone-sage-surface)] text-[color:var(--hero-tone-sage-title)] hover:bg-[#e5efe7] cursor-pointer font-semibold";
    ...
    <> {/* Replaced outer section and its classes with a fragment */}
      <div className="flex justify-between items-center gap-3 mb-4">
        ...
        <div className="flex items-center gap-4 ml-auto">
          <label className="flex items-center gap-2 text-base font-semibold text-[color:var(--hero-tone-sage-title)] cursor-pointer">
            <input
              type="checkbox"
        ...
        <div className="mt-6 pt-6 border-t border-gray-200">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
            ...
            <div className="space-y-3">
              <details className="text-sm text-[color:var(--hero-tone-sage-title)]">
            ...
            <div className="flex lg:justify-end">
              <div className="text-xl lg:text-2xl font-extrabold text-[color:var(--hero-tone-sage-title)]">
